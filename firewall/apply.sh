...
log "  3. From another machine, run:"
log "        nmap -Pn -p 80,443,3000,8080,8081,8123,13000,18080,18123,8082,5580 <host>"
log "     Only 80 and 443 should be open from outside the LAN. Ports published"
log "     by Coolify (8123/3000/8080) may answer from ADMIN_CIDR when"
log "     ALLOW_ADMIN_TO_PUBLISHED=1."
log "  4. Reboot once and re-check, to confirm the rules survive."
log ""
log "Note: 8081 and the loopback break-glass ports 18123/13000/18080 are bound"
log "      to 127.0.0.1 by docker-compose and should already be gone; 8082/5580"
log "      are what this firewall closes off."
